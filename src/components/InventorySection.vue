<template>
  <div class="grid grid-cols-1 sm:grid-cols-1 gap-10">
    <div
      v-for="(section, index) in inventory"
      :key="index"
    ...
    >
      ...
      >
        ...
        <i
          class="ri-arrow-down-s-line ri-lg transform transition-transform duration-200"
        ...
        >
          ...
          <div v-if="section.inputType === 'toggle'" class="sm:w-2/3 flex justify-end">
            <label class="inline-flex items-center cursor-pointer">
              ...
              <div
                class="w-11 h-6 rounded-full relative transition-colors duration-200 ease-in-out"
              ...
              >
                <span
                  ...
                  :class="{ 'translate-x-full': item.selected }"
                ></span>
              </div>
